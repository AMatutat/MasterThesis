...
public class Level implements IndexedGraph<Tile> {
    ...
    private void addConnectionsToNeighbours(Tile checkTile) {
        ...
        // upperTile
        Coordinate upper =
                new Coordinate(checkTile.getGlobalPosition().x, checkTile.getGlobalPosition().y + 1);
        ...
        // leftTile
        Coordinate left =
                new Coordinate(checkTile.getGlobalPosition().x - 1, checkTile.getGlobalPosition().y);
