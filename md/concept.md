...
Um mehr optische Abwechslung zu erlauben, können sowohl Room-Templates als auch Replacements mit Design-Label markiert werden. Nur wenn das Design-Label eines Replacement, mit dem des Room-Templates übereinstimmt, können diese zusammen verwendet werden. Design-Labels können genutzt werden, um bestimmte Layouts nur in bestimmten Regionen, wie Wald oder Gebirge, anzuwenden. So können sich die verschiedenen Regionen nicht nur optisch, sondern auch strukturell voneinander unterscheiden.  
